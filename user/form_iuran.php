...
?>
    ...
    <form class="row g-3" action="" method="POST">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="durasi" name="durasi" value="" onchange="return cek_return()" placeholder="Bulan ke" required readonly>
            </input>
            <br>
        </div>
        ...
        <div class="col-12">
            <br>
            <button type="submit" class="btn btn-warning text-dark" style="box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.3);"><i class="fas fa-money-check-alt fa-fw mr-1"></i>Ajukan Iuran</button>
        </div>
        </form>
        <?php
