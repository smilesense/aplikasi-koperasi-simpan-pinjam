...
?>
    ...
    <form class="row g-3" action="" method="POST">
        ...
        <div class="col-12">
            <br>
            <button type="submit" class="btn btn-success text-white" style="box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.3);"><i class="fas fa-money-check-alt fa-fw mr-1"></i>Ajukan Simpanan</button>
        </div>
        </form>
        <?php
