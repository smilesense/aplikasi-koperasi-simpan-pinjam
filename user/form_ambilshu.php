        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if ($res_password == 0){
                ...
                if ($norek == '' || $norek == 0){
                    ...
                    $sql = mysqli_query($koneksi,"INSERT INTO konfirmasi_tarikshu(id_user, nama_lengkap, nominal, status, tanggal_shu) VALUES ('$id','$nama_user','$nominal','Menunggu Konfirmasi', NOW())");
                    if ($sql){
                        ?>
                        <script type='text/javascript'> 
